...
`,
      ...
      writeFileSync(
        ...
        [
          'import fs from "node:fs";',
          'import { syncBuiltinESMExports } from "node:module";',
          `import { waitForRaceRelease } from ${JSON.stringify(new URL("./helpers/race-barrier.mjs", import.meta.url).href)};`,
          ...
          "    waitForRaceRelease(release, { parentPid: coordinatorPid });",
          "  }",
